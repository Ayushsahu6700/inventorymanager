...
class approvedQrPage extends StatefulWidget {
  ...
  @override
  _approvedQrPageState createState() => _approvedQrPageState();
}

class _approvedQrPageState extends State<approvedQrPage> {
  bool camState = false;
  @override
  void initState() {
              ...
              children: [
                ...
                materialButtonX(
                    ...
                    onClick: () {
                      ...
                      } else if (widget.approvedPackage.packageId != qrid) {
                        setState(() {
                          qrid = "";
                        });
                        Scaffold.of(context).showSnackBar(
