...
class approvedDetails extends StatefulWidget {
  InwardingPackagesModel approvedPackage;
  int franchise, distributor, branch, hub, warehouse, deliveryBoyCount;
  approvedDetails({
    required this.approvedPackage,
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          bottom: widget.approvedPackage.isFinalStation == true
              ? TabBar(
        ...
        body: widget.approvedPackage.isFinalStation == true
            ? TabBarView(
                children: [
                  outForDelivery(
                    deliveryBoyCount: widget.deliveryBoyCount,
                    approvedPackage: widget.approvedPackage,
                  ),
                  approvedDetailsInternalOutward(
                      approvedPackage: widget.approvedPackage,
...
class approvedDetailsInternalOutward extends StatefulWidget {
  InwardingPackagesModel approvedPackage;
  ...
  @override
  _approvedDetailsInternalOutwardState createState() =>
      _approvedDetailsInternalOutwardState();
}

class _approvedDetailsInternalOutwardState
    extends State<approvedDetailsInternalOutward> {
  ...
  fetchdata() async {
    ...
    warehousemap =
        str == null ? null : Map<String, String>.from(json.decode(str));
  }
                            ...
                            children: [
                              ...
                              Center(
                                child: materialButtonX(
                                    ...
                                    onClick: () {
                                      print(id + "---------------------------");
                                      print(widget.approvedPackage.packageId
                                          .toString());
                                      if (selectDestinationType ==
                                        ...
                                        BlocProvider.of<outwardCubit>(context)
                                            .outward(
                                                widget.approvedPackage.packageId
                                                    .toString(),
                                                id,
                                                selectDestinationType,
                                                nameController.text,
...
class outForDelivery extends StatefulWidget {
  ...
  InwardingPackagesModel approvedPackage;
  outForDelivery(
      {required this.deliveryBoyCount, required this.approvedPackage});
  @override
