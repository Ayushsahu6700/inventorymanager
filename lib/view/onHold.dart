...
import 'onHoldDetails.dart';

class onHold extends StatefulWidget {
  final VoidCallback openDrawer;
  onHold({required this.openDrawer});
  @override
...
class _onHoldState extends State<onHold> {
  ...
  List<InwardingPackagesModel> onHoldList = [];
  ...
  void initState() {
    ...
    BlocProvider.of<onHoldCubit>(context).getList();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: FittedBox(child: Text("On Hold")),
        centerTitle: true,
        actions: [
          Padding(
      ...
      body: BlocListener<notificationCubit, notificationState>(
        ...
        child: BlocListener<onHoldCubit, onHoldState>(
          listener: (context, state) {
            // TODO: implement listener
            if (state.code == "00") {
              Scaffold.of(context).showSnackBar(
              ...
              setState(() {
                onHoldList = state.onHoldPackages;
                loadingList = false;
              });
            } else {
              setState(() {
              ...
              : RawScrollbar(
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        for (int i = 0; i < onHoldList.length; i++)
                          Padding(
                            padding: const EdgeInsets.symmetric(
